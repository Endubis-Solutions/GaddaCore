  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <div className="hover:border-primary group relative rounded-md border border-dashed border-zinc-200 bg-zinc-50/50 p-8 text-center transition-all">
          <Input
            type="file"
          ...
          <label htmlFor={uniqueId} className="flex cursor-pointer flex-col items-center">
            {isUploading ? (
              <Loader2Icon className="text-primary mb-4 h-10 w-10 animate-spin" />
            ) : currentFile ? (
              <FileText className="text-primary mb-4 h-10 w-10" />
            ) : (
              <Upload className="group-hover:text-primary mb-4 h-10 w-10 text-zinc-300 transition-colors" />
            )}
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                size="sm"
                type="button"
                className="h-6 gap-1.5 px-2 text-emerald-600 hover:bg-emerald-50 hover:text-emerald-700"
              >
            ...
            <PopoverContent className="w-80 border-zinc-100 p-4 shadow-2xl" align="end">
              <div className="space-y-3">
                ...
                <div className="rounded border border-zinc-100 bg-zinc-50 p-2">
                  <p className="font-mono text-[11px] leading-relaxed break-all text-zinc-600">
                    {ipfsHash}
                  </p>
                </div>
