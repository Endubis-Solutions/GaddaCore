import { BlockfrostProvider, MeshTxBuilder, serializePlutusScript, UTxO } from "@meshsdk/core";
...
export function getScript() {
  const scriptCbor = applyParamsToScript(AikenBluePrint.validators[0].compiledCode, []);
