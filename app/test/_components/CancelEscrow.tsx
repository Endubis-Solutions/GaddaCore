...
const CancelEscrow = () => {
  ...
  const handleCancelEscrow = async () => {
    ...
    try {
      ...
      if (inputDatum.constructor.toString() === "1") {
        ...
        const [initiatorAddressObj, initiatorAmount] = inputDatum.fields;
        ...
        txBuilder.txOut(initiatorAddress, initiatorToReceive);
  ...
  return (
    <section className="flex flex-col rounded-md border p-4">
      <div>
        <Label className="mb-1 text-sm font-medium">Deposit Tx Hash</Label>
        <Input
          value={depositTxHash}
