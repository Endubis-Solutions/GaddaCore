...
const InitateEscrow = () => {
  ...
  return (
    <section className="flex flex-col rounded-md border p-4">
      {/* Elegant Title Added */}
      <h2 className="text-primary mb-2 text-2xl font-bold">Initiate Escrow Funding</h2>
      ...
      <div className="space-y-6">
        {/* 1. FUNDER DEPOSIT */}
        <div>
          <Label className="mb-1 text-sm font-medium">Funder Deposit (ADA)</Label>
          <Input
            type="number"
            value={amount || 0}
        ...
        {/* 2. RECIPIENT ADDRESS */}
        <div>
          <Label className="mb-1 text-sm font-medium">Recipient Wallet Address</Label>
          <Input
            type="text"
        ...
        {/* 3. DEADLINE (Calendar) */}
        <div>
          <Label className="mb-1 block text-sm font-medium">Contract Deadline</Label>
          <Popover>
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm">
            Upload the legally binding document to Pinata (IPFS) to generate the immutable hash
