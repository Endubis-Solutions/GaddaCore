...
import { deserializeDatum, serializeAddressObj, deserializeAddress, DEFAULT_REDEEMER_BUDGET } from '@meshsdk/core'
...
const RaiseInitiatorDispute = () => {
    ...
    const handleDispute = async () => {
        ...
        logAction({
            ...
            details: { signer: walletAddress, step: 'Attempting to file dispute', activeUtxo: activeEscrowTxHash }
        });
        ...
        try {
            ...
            console.log("new Initiator Dispute Datum", stringifyPlutusData(newInitiatorDisputeDatum.fields))
            ...
            logAction({
                ...
                method: 'RaiseInitiatorDispute',
                txHash: newTxHash,
                details: { signer: walletAddress, step: 'Dispute filed successfully', newDatum: 'InitiatorDispute', ipfsUrl }
            });
    ...
    return (
        <section className='p-4 space-y-4 border rounded-md border-orange-300 bg-orange-50'>
            <div className='text-xl font-bold text-orange-700'>
                Step 1: Raise Initiator Dispute
            </div>
            ...
            <div className="space-y-4">
                <div>
                    <Label className="text-sm font-medium mb-1">Active Escrow UTxO Hash (ConStr1)</Label>
                    <Input
            ...
            <Button
                ...
                loading={isPending}
                className="mt-4 w-full h-10 mb-2 bg-orange-600 hover:bg-orange-700">
...
const SubmitRecipientEvidence = () => {
    ...
    const handleSubmitEvidence = async () => {
        ...
        logAction({
            ...
            details: { signer: walletAddress, step: 'Attempting to submit evidence', activeUtxo: initiatorDisputeTxHash }
        });
        ...
        try {
            ...
            const inputDatum = deserializeDatum<InitiatorDisputeDatum>(
                escrowUtxo.output.plutusData!,
            );
            ...
            logAction({
                ...
                method: 'SubmitRecipientEvidence',
                txHash: newTxHash,
                details: { signer: walletAddress, step: 'Evidence submitted successfully', newDatum: 'RecipientDispute', ipfsUrl }
            });
    ...
    return (
        <section className='p-4 space-y-4 border rounded-md border-blue-300 bg-blue-50'>
            <div className='text-xl font-bold text-blue-700'>
                Step 2: Submit Recipient Evidence
            </div>
            <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-4">
                <div>
                    <Label className="text-sm font-medium mb-1">Initiator Dispute UTxO Hash (ConStr2)</Label>
                    <Input
            ...
            <Button
                ...
                disabled={isPending || !ipfsUrl}
                loading={isPending}
                className="mt-4 h-10 mb-2 w-full bg-blue-600 hover:bg-blue-700">
...
const DisputeActions = () => {
    return (
        <section className='p-4 space-y-6 border rounded-lg bg-gray-50'>
            <h2 className="text-2xl font-bold mb-4 text-red-700">
                Dispute & Evidence Submission Workflow
            </h2>
            <p className="text-sm text-muted-foreground border-l-4 border-red-400 pl-3 py-1">
                This process moves the escrow UTxO through the dispute states. The final state (`RecipientDispute`) requires a **Resolution** transaction to proceed, which is not yet implemented.
            </p>
            ...
            <div className="relative flex justify-center items-center py-4">
                ...
                <span className="relative z-10 bg-gray-50 p-2 text-sm font-semibold text-gray-500 rounded-full border border-gray-300">
                    TRANSITION
                </span>
            </div>
