                ...
                <section>
                                ...
                                <Popover>
                                    ...
                                    <PopoverContent className="w-80 p-5 shadow-2xl border-zinc-100" align="start">
                                        <div className="space-y-3">
                                            <h3 className="font-bold flex items-center gap-2 text-primary text-sm uppercase tracking-wider">
                    ...
                    <div className="lg:col-span-7">
                        <Tabs defaultValue="initiate" className="w-full">
                            <TabsList className="grid w-full grid-cols-2 mb-4 bg-zinc-100/50 p-1 rounded-md">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                className="border-0 border-b border-zinc-300 bg-zinc-50 rounded-none w-full pl-9 h-12 focus-visible:ring-0 focus-visible:border-primary font-mono text-sm"
                                            />
                                        </div>
                                    </div>
                                    <Button onClick={handlePartialSign} disabled={isCompletePending || !depositTxHash} className="w-full h-12 rounded-md gap-2 text-sm">
                            ...
                            <TabsContent value="finalize" className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                <div className=" p-8 space-y-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase text-zinc-400 tracking-widest">Partial CBOR Data</label>
                                        <Textarea
                                            value={partialSignedTxCbor}
                                            onChange={(e) => setPartialSignedTxCbor(e.target.value)}
                                            className="min-h-[150px] bg-zinc-50 outline-none focus-visible:ring-0 border-zinc-200 focus-visible:border-b-primary font-mono text-[10px] rounded-none p-4 shadow-inner border-0 border-b border-b-zinc-300"
                                            placeholder="Paste the CBOR string provided by the initiator..."
                                        />
                                    </div>
                                    <Button onClick={handleSubmitFinal} disabled={isSubmitting || !partialSignedTxCbor} className="w-full h-14 bg-primary rounded-md shadow-lg shadow-indigo-100 gap-2">
